...
class ServiceRequest(db.Model):
    ...
    sr_customer_id = db.Column(db.Integer, foreign_key = True)
    sr_service_provider_id = db.Column(db.Integer, foreign_key = True)
    sr_service_id = db.Column(db.Integer, foreign_key = True)
...
class ServiceFeedback(db.Model):
    ...
    sf_service_request_id = db.Column(db.Integer, foreign_key = True)
